jQuery(document).ready(function ($) {
	...
	// fixed newsletter style bug
	var $newsletterForm = $("#mc4wp-form-1");
	$newsletterForm.find("p:last input").appendTo($newsletterForm.find("p:first")).addClass("newsletter-btn");
	$newsletterForm.find(".newsletter-btn").text("Subscribe");
